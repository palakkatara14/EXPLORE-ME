...
const genAI = new GoogleGenerativeAI(process.env.GENAI_API_KEY); // Replace with your API key

// Unsplash API access key
const unsplashAccessKey = process.env.UNSPLASH_ACCESS_KEY; // Replace with your actual Unsplash access key
